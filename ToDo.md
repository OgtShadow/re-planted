...
- [✅] Implementacja Trybu Offline na poziomie kontrolera – przejęcie autonomicznego zarządzania stanem urządzeń w przypadku utraty połączenia WAN (Fail-safe). Szczegóły: apps/ClientServer/README.md
...
- [ ] Dodanie połączenia Watchdoga z esp.
...
- [✅] Symulacja awarii warstwowych – weryfikacja poprawności uruchamiania trybów Fail-safe w Kontrolerze IoT.